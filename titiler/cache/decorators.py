...
def cached_tile(  # noqa: C901
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs) -> Response:
            ...
            # Generate cache key with additional excluded params
            try:
                ...
                if cached_data:
                    ...
                    try:
                        ...
                        if (
                            ...
                            # Simple content
                            response = Response(content=cached_data)
                        ...
                        if hasattr(response, "body"):
                            ...
                            if hasattr(response, "body_iterator"):
                                ...
                                async for chunk in response.body_iterator:
                                    body_content += chunk
                                # Reset body iterator
                                response.body_iterator = iter([body_content])
                            ...
                            # Can't cache this response type
                            logger.warning(
                                f"Cannot cache response type {type(response)} in {func.__name__}"
                            )
                            if hasattr(response, "headers"):
